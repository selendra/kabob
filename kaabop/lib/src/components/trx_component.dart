...
//       child: trx.isNotEmpty
//           ? MyText(text: trx[0]['date'].toString(), color: "#FFFFFF")
//           : MyText(text: "Empty", color: "#FFFFFF"),
//     );
//   }

//   static Widget trxList(Map trx, {String tab}) {
...
//                 context,
//                 transitionRoute(
//                   TrxHistoryDetails(trx[index], tab),
//                 ),
//               );
//             },
...
//     return trx.length != 0
//         ? Column(
//             // Prevent The Month Have No Trx
//             children: <Widget>[
//               Container(
//                 margin: EdgeInsets.fromLTRB(16, 0, 16, 0),
//                 child: Divider(
//                     color: hexaCodeToColor(AppColors.textColor), height: 1.0),
//               ),
